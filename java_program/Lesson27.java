...
public class Lesson27 extends JFrame{
    ...
    JTree theTree; //%%theTree%%container%% 
    ...
    private class ListenForButton implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e){
            ...
            if(e.getSource() == button1){
                ...
                Object treeObject = theTree.getLastSelectedPathComponent(); //%%treeObject%%most recent holder%%

                // Cast the Object into a DefaultMutableTreeNode

                DefaultMutableTreeNode theFile = (DefaultMutableTreeNode) treeObject; //%%theFile%%walker%% 
