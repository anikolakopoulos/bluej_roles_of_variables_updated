...
public class TreeIconDemo2 extends JPanel implements TreeSelectionListener {
    ...
    public void valueChanged(TreeSelectionEvent e) {
        DefaultMutableTreeNode node = (DefaultMutableTreeNode) tree.getLastSelectedPathComponent(); //%%node%%walker%%

        if (node == null) return;

        Object nodeInfo = node.getUserObject(); //%%nodeInfo%%most recent holder%%
        if (node.isLeaf()) {
    ...
    private class MyRenderer extends DefaultTreeCellRenderer {
        ...
        protected boolean isTutorialBook(Object value) {
            DefaultMutableTreeNode node_ = (DefaultMutableTreeNode)value; 
            BookInfo nodeInfo = (BookInfo)(node_.getUserObject());
